...
import { LensDistortionShader } from './public/shaders/LensDistortionShader.js'
...
loader.load('models/gltf/jellyfish.glb', function (gltf) {
// loader.load('models/gltf/super_mario_mushroom.glb', function (gltf) {    
...
function transformMesh(){
    ...
    const rotationAxis = new THREE.Vector3(1, 0, 0); // Rotate around axis
    ...
    for (let i = 0; i < 99000; i ++) {
        sampler.sample(tempPosition) // Sample a random position in the model
        // tempPosition.applyMatrix4(rotationMatrix); // Rotate the point position  
        vertices.push(tempPosition.x, tempPosition.y, tempPosition.z) // Push coordinates into the array
    }
...
function introAnimation() {
    ...
    .onComplete(function () { //on finish animation
        ...
        document.querySelector('#three-container').classList.add('ended')
